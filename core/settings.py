...
CSRF_TRUSTED_ORIGINS = [
    ...
    "http://wfdash.pythonanywhere.com",
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "http://192.168.11.218:8000/https://7fd0-168-210-87-242.ngrok-free.app",
    "https://*",
    "https://76b0-196-39-63-50.ngrok-free.app/",
]

# Debug toolbar configuration
INTERNAL_IPS = ["127.0.0.1", "192.168.11.218"]
...
# Security settings - unified and deduplicated
# CSRF settings
CSRF_COOKIE_NAME = "csrftoken"
CSRF_HEADER_NAME = "HTTP_X_CSRFTOKEN"
CSRF_COOKIE_HTTPONLY = True
CSRF_USE_SESSIONS = False  # Setting to False since we're using cookies
CSRF_COOKIE_SAMESITE = "Lax"

# Session settings
SESSION_ENGINE = "django.contrib.sessions.backends.db"  # Using DB instead of cached_db for simplicity
...
PUBLIC_QUOTE_DIR = os.path.join(MEDIA_ROOT, "public_quotes")
PUBLIC_QUOTE_EXPIRY = timedelta(days=7)  # Files expire after 7 days

# Vendor files locations
VENDOR_FILES = {
...
# EMAIL_HOST_PASSWORD = 'mwca qdoq jhul jnuh'
...
# Add these settings
TWILIO_ACCOUNT_SID = "AC63f41d779cfa0b3b6147e607f1130c60"
TWILIO_AUTH_TOKEN = "70785d52ccde5345b955c355da6b1936"
TWILIO_WHATSAPP_NUMBER = "+14155238886"  # This is usually the Sandbox number


# Add this near the end of your settings file

# Base URL for generating absolute URLs (no trailing slash)
