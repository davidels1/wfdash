...
class Customers(models.Model):
    ...
    email = models.CharField(max_length=255, null=True, blank=True)  # Changed from EmailField
    ...
    def __str__(self):
        return f"{self.customer} - {self.company}" if self.customer else 'Unnamed Customer'
...
class Suppliers(models.Model):
    ...
    supply_tags = models.CharField(max_length=500, null=True, blank=True, 
...
class Company(models.Model):
    ...
    def __str__(self):
        return self.company or 'Unnamed Company'
